...
public class list {
    ...
    public static void deleteNthfromend(int n) {
        // calculation of size of linkedlist
        int size = 0;
        Node temp = head;
        while (temp != null) {
            temp = temp.next;
    ...
    // slow and fast pointer approach to find the mid of ll
    ...
    public boolean isPalindrome() {
        ...
        Node right = prev;
        Node left = head;
        // step3:compare first half and seconf half
        while (right != null) {
    ...
    public static boolean isCycle() {// floyds cycle detection algorithm
        Node slow = head;
        Node fast = head;
